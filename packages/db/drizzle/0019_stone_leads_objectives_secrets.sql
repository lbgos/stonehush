...
CREATE UNIQUE INDEX `lead_attempt_lead_sequence_unique` ON `lead_attempts` (`lead_id`,`sequence`);--> statement-breakpoint
CREATE UNIQUE INDEX `lead_attempt_engagement_id_unique` ON `lead_attempts` (`engagement_id`,`id`);--> statement-breakpoint
CREATE INDEX `lead_attempt_lead_created_idx` ON `lead_attempts` (`lead_id`,`created_at`,`id`);--> statement-breakpoint
CREATE TABLE `leads` (
	`id` text PRIMARY KEY NOT NULL,
	`contract_version` integer NOT NULL,
	`engagement_id` text NOT NULL,
...
--> statement-breakpoint
CREATE INDEX `lead_engagement_created_idx` ON `leads` (`engagement_id`,`created_at`,`id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `objective_engagement_created_idx` ON `objectives` (`engagement_id`,`created_at`,`id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `secret_verification_engagement_id_unique` ON `secret_verifications` (`engagement_id`,`id`);--> statement-breakpoint
CREATE INDEX `secret_verification_secret_created_idx` ON `secret_verifications` (`secret_id`,`created_at`,`id`);--> statement-breakpoint
