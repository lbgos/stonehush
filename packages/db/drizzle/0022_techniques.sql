CREATE TABLE `techniques` (
	...
	CONSTRAINT "technique_prerequisites_json" CHECK(json_valid("techniques"."prerequisites_json") and length(cast("techniques"."prerequisites_json" as blob)) <= 16384),
	...
	CONSTRAINT "technique_procedure_json" CHECK(json_valid("techniques"."procedure_json") and length(cast("techniques"."procedure_json" as blob)) <= 131072),
